...
Trabalho do jeito tradicional: **fundamento forte, domínio bem modelado e código previsível em produção**. Modinha passa, sistema fica.
...
### Freelance — Backend / Infraestrutura  
**Projeto Riolivre**
- Desenvolvimento de APIs REST e serviços backend com regras de negócio complexas
- Arquitetura, provisionamento e operação de ambientes em AWS
- Integrações assíncronas (telemetria, GPS, timestamps)
- Monitoramento, análise de falhas e resolução de incidentes em produção
- Refatoração contínua visando confiabilidade e manutenibilidade

### Fundação para Inovações Tecnológicas (FITEC)
**Especialista em Desenvolvimento**
- Desenvolvimento com FastAPI, MongoDB e PostgreSQL
- Aplicação prática de Clean Architecture
- Sustentação e evolução de soluções em AWS (ECS, Lambda, VPC, CloudFront)
- CI/CD com AWS CDK

### Instituto de Pesquisa Itriad
**Desenvolvedor Backend**
- Backends em Go, NestJS e C#
- Sistemas de rastreabilidade, produção e notificações
